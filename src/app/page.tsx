...
import { Search, ShoppingBag, PartyPopper, Gift, Crown, Balloon, ListChecks, Phone, ShoppingCart, Check, Menu, Bell, Wand2 } from "lucide-react";
...
export default function HomePage() {
  const { cart, addToCart, isInCart, cartCount } = useCart();
    ...
    <main className={`animate-fade-in ${styles.main}`}>
      ...
      <header className={styles.appHeader}>
        ...
        <div className={styles.searchContainer}>
          ...
          <input 
            type="text" 
            placeholder="Buscar produtos, kits e mais..." 
      ...
      <section className={styles.heroSection}>
        <img 
          src="https://images.unsplash.com/photo-1502635385003-ee1e6a1a742d?auto=format&fit=crop&q=80&w=600&h=400" 
      ...
      {/* WhatsApp Banner */}
      <a
        href="https://wa.me/5569992693194"
        target="_blank"
